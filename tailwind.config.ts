  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        text: {
          primary: '#111827',    // Almost black for highest contrast
        ...
        dark: {
          bg: '#0f172a',         // Deeper dark background
          card: '#1e293b',       // Enhanced card background
          text: '#f1f5f9',       // High contrast light text
          muted: '#94a3b8',      // Better contrast muted text
      ...
      fontFamily: {
        sans: ['Roobert', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Helvetica Neue', 'Arial', 'sans-serif'],
        avenir: ['Avenir Next LT Pro Demi', 'sans-serif'],
        heading: ['Roobert', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'sans-serif'],
      },
      fontSize: {
      ...
      // Brand-specific border radius system
      borderRadius: {
        'none': '0',
        'sm': '0.375rem',
        DEFAULT: '0.5rem',
      ...
      boxShadow: {
        ...
        'brand-sm': '0 2px 4px 0 rgb(37 99 235 / 0.1)',
        'brand': '0 4px 12px 0 rgb(37 99 235 / 0.15)',
        'brand-lg': '0 8px 24px 0 rgb(37 99 235 / 0.2)',
        'brand-hover': '0 12px 32px 0 rgb(37 99 235 / 0.25)',
