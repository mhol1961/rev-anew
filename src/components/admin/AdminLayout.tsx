...
const navigation = [
  ...
  { name: 'Page Editor', href: '/admin/page-editor', icon: 'page-editor' },
  ...
  { name: 'Support Articles', href: '/admin/support-articles', icon: 'support-articles' },
    ...
    const checkAuth = async () => {
      try {
        ...
        if (!currentUser) {
          ...
          // Remove this in production after setting up proper admin user
        ...
        // TEMPORARY DEV MODE: Allow access without authentication
        if (process.env.NODE_ENV === 'development') {
          console.log('DEV MODE: Bypassing authentication due to error')
          setUser({
            id: 'dev-admin',
            auth_id: 'dev-admin',
            email: 'dev@admin.local',
